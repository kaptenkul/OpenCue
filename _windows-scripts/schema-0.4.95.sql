...
--
-- Name: find_duration(timestamp with time zone, timestamp with time zone); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: trigger__before_delete_layer_drop_limit(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: layer_limit; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: limit_record; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: layer before_delete_layer_drop_limit; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER before_delete_layer_drop_limit BEFORE DELETE ON public.layer FOR EACH ROW EXECUTE PROCEDURE public.trigger__before_delete_layer_drop_limit();
